                      ...
                      child: Column(
                        ...
                        children: [
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'nnv46x35' /* Votaciones Pendientes */,
                                            ),
                                            textAlign: TextAlign.start,
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'kphqz3hi' /* Votaciones realizadas */,
                              ),
                              textAlign: TextAlign.start,
                              style: FlutterFlowTheme.of(context)
                                  .titleMedium
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'uj7jsxmo' /* Informacion de las votaciones */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .titleMedium
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'hkk2zmjw' /* Lineamientos de las votaciones */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'g4os7kcp' /* Verifica tu faltante en votaci... */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
